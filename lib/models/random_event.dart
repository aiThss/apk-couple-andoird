class RandomCategory {
  ...
  factory RandomCategory.fromJson(Map<String, dynamic> json) {
    return RandomCategory(
      ...
      label: localizeRandomText(json['label'] as String? ?? ''),
      description: localizeRandomText(json['description'] as String? ?? ''),
    );
  }
}
...
class RandomEvent {
  ...
  factory RandomEvent.fromJson(Map<String, dynamic> json) {
    return RandomEvent(
      ...
      prompt: localizeRandomText(json['prompt'] as String? ?? ''),
      detail: localizeOptionalRandomText(json['detail'] as String?),
      createdAt:
...
String? localizeOptionalRandomText(String? value) {
...
String localizeRandomText(String value) {
  final trimmed = value.trim();
  return _legacyRandomText[trimmed] ?? trimmed;
}

const _legacyRandomText = <String, String>{
